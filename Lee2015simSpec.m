...
switch column
    ...
    case 'a1_2013'
        ...
        conductance = [0.1*ones(1, 13);... % g_L
            0.5, 0, 8, 0.3, 0, 2, 0, 4, 2, 0, 4, 0, 4;... % g_M
            zeros(1, 7), 4, 0, 0, 1.6, 0, 0;... % g_CaH
            zeros(1, 13);... % g_CaL
            zeros(1, 13);... % g_h
            0, 0, -1, -1, 2, 1, 1, 2, 1, 1, 2, 0, -1;... % Iapp
            .2, .02, 0, 1, .03, 0, 0, 3, 0, 0, 3, 0, 0]; % g_ext
        
    case 'a1_2015'
        
        conductance = [0.1*ones(1, 13);... % g_L
            0.3, 0, 6, 0.9, 0, 0.3, 0, 0.6, 0.3, 0, 0.6, 0, 3;... % g_M
            zeros(1, 7), 4, 0, 0, 2, 0, 0;... % g_CaH
            0, 0, 1, zeros(1, 9), 0.3;... % g_CaL
            zeros(1, 13);... % g_h
            -2, 0, 0, -10, -5, 0.8, -1.4, -5, 0.8, -1.4, -5, 4, -4;... % Iapp
            .5, 0, 0, 0.1, .03, 0, 0, 0.1, 0, 0, 0.1, 0, 0]; % g_ext
    ...
    case 'par'
        ...
        conductance = [0.1*ones(1, 4), 0.2, 0.1*ones(1, 8);... % g_L
            0.6, 0, 3, 1, 0, 8, 0, 2, 8, 0, 3, 0, 3;... % g_M
            zeros(1, 7), 4, 0, 0, 2, 0, 0;... % g_CaH
            0, 0, 1, zeros(1, 9), 0.5;... % g_CaL
            zeros(1, 7), 0.1, 0, 0, 0.1, 0, 0;... % g_h
            -4, 2, 2, 0, -4, -5, -5, -5, -2, -3, -1, 0, -3;... % Iapp
