...
function [sim_vary, top_down_flag, bottom_up_flag] = get_sim_vary(simulation)
...
elseif strcmp(simulation, 'LIP_theta')
    ...
    sim_vary = {'(C1deepIBdendrite,C1deepRSdendrite)', 'Soffset', 125;...
...
elseif strcmp(simulation, 'Pul_Poisson')
    ...
    sim_vary = {'(C2L4RS,C2L4FS)', 'rate', [50 100];...
        ...
        '(C1deepIBdendrite,C1supRS,C1supFS)', 'gExtPul', permute([3 .2 .02; zeros(1, 3)], [3 1 2]);...
        '(C1deepSI->C1deepIBdendrite,C2deepSI->C2deepIBdendrite)', 'gSYN', 0;...
        '(C1deepIBdendrite,C1deepRSdendrite,C2deepIBdendrite,C2deepRSdendrite)', 'Sfreq', 25;...
        };
...
elseif strcmp(simulation, 'Pul_Poisson_theta')
    ...
    sim_vary = {'(C1deepIBdendrite,C1supRS,C1supFS,C2deepIBdendrite,C2supRS,C2supFS)', 'frequencyPul', [0 15];...
...
elseif strcmp(simulation, 'Pul_Spikes_theta')
    ...
    sim_vary = {'(C1deepIBdendrite,C1supRS,C1supFS,C2deepIBdendrite,C2supRS,C2supFS)', 'gSpikesPul', permute([3 .2 .02; zeros(1,6)], [3 1 2]);...
        '(C1deepIBdendrite,C1supRS,C1supFS,C2deepIBdendrite,C2supRS,C2supFS)', 'SfreqPul', 15;...
